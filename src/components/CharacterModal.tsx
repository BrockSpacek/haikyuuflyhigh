  ...
  return (
    <div className="fixed inset-0 bg-black/80 flex justify-center items-center z-50 p-4">
      <div className="bg-gray-900 rounded-2xl border-2 border-gray-700 w-full max-w-3xl max-h-[90vh] overflow-hidden shadow-2xl">
        ...
        {/* Content */}
        <div className="flex flex-col md:flex-row overflow-y-auto max-h-[calc(95vh-120px)]">
          {/* Left: Character Image */}
          <div className="md:w-2/5 p-6 bg-gray-800 flex flex-col">
            <div
              className={`relative p-1 bg-gradient-to-br ${getRarityGradient(
                character.rarity
              )} rounded-xl mb-4`}
            >
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between p-3 bg-gray-700 rounded-lg">
                ...
                <span
                  className={`font-bold text-lg bg-gradient-to-r ${getRarityGradient(
                    character.rarity
